...
# SDL2_mixer: optional audio support
find_package(SDL2_mixer QUIET)
if(NOT SDL2_mixer_FOUND AND NOT TARGET SDL2_mixer::SDL2_mixer)
    find_package(PkgConfig QUIET)
    if(PkgConfig_FOUND)
        ...
        if(SDL2_MIXER_FOUND)
            ...
            target_link_directories(SDL2_mixer::SDL2_mixer INTERFACE ${SDL2_MIXER_LIBRARY_DIRS})
            set(VSE_HAS_AUDIO 1 CACHE BOOL "Audio support enabled" FORCE)
        else()
            set(VSE_HAS_AUDIO 0 CACHE BOOL "Audio support disabled" FORCE)
            message(STATUS "SDL2_mixer not found — building without audio support")
        endif()
    else()
        set(VSE_HAS_AUDIO 0 CACHE BOOL "Audio support disabled" FORCE)
        message(STATUS "pkg-config not available — building without audio support")
    endif()
elseif(TARGET SDL2_mixer::SDL2_mixer)
    set(VSE_HAS_AUDIO 1 CACHE BOOL "Audio support enabled" FORCE)
    message(STATUS "SDL2_mixer found — audio support enabled")
else()
    set(VSE_HAS_AUDIO 0 CACHE BOOL "Audio support disabled" FORCE)
    message(STATUS "SDL2_mixer not found — building without audio support")
endif()
